...
for family in (
    "deep_dive", "biotech_news", "fda_catalysts", "fda_advisory_meetings",
    "registry_changes", "earnings_calendar", "regime", "social_attention",
    "social_alerts", "baseline_alerts", "social_whispers_unanchored",
):
    assert family in source, family
