...
## Integrated in the 2.6.4 review branch
...
The integration preserves OMNI-01/02, schema 2.8 default exports and historical
validators. Profiles use schema 2.9 with embedded configuration. It also adds
...
workspace backup. Do not overwrite historical archives when moving to 2.6.4.
